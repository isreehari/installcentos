...
export NODE_IP=${NODE_IP:="$(ip route get 8.8.8.8 | awk '{print $NF; exit}')"}
export API_PORT=${API_PORT:="8443"}

echo "******"
echo "* Your domain is $DOMAIN "
echo "* Your IP is $IP "
echo "* Your Node IP is $NODE_IP"
...
curl -o inventory.download $SCRIPT_REPO/multiplenodes/master/inventory.ini
